...
<head>
	...
	<title>Rent Registration Form</title>
...
<body>
 	<div class="generic-container">
		...
		<div class="well lead">Rent Registration Form</div>
	 	<form:form method="POST" modelAttribute="viewManager" class="form-horizontal">
			...
			<div class="row">
				<div class="form-group col-md-12">
					...
					<div class="col-md-7">
						<form:select path="contract" items="${contracts}" multiple="false" itemValue="id" itemLabel="contractNumber" class="form-control input-sm" />
						<div class="has-error">
